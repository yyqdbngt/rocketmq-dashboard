...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'studioUser.action': { zh: '操作', en: 'Actions' },
  'studioUser.adminPermission': { zh: '管理员权限', en: 'Admin Permission' },
  'studioUser.adminRole': { zh: '管理员', en: 'Admin' },
  'studioUser.allRoles': { zh: '全部权限', en: 'All Roles' },
  'studioUser.allStatuses': { zh: '全部状态', en: 'All Statuses' },
  'studioUser.changeMyPassword': { zh: '修改我的密码', en: 'Change My Password' },
  'studioUser.changePassword': { zh: '改密', en: 'Change Password' },
  'studioUser.changePasswordFailed': { zh: '修改密码失败', en: 'Failed to change password' },
  'studioUser.createFailed': { zh: '创建用户失败', en: 'Failed to create user' },
  'studioUser.createTitle': { zh: '新建 Studio 用户', en: 'New Studio User' },
  'studioUser.createUser': { zh: '新建用户', en: 'New User' },
  'studioUser.created': { zh: '用户已创建', en: 'User created' },
  'studioUser.createdAt': { zh: '创建时间', en: 'Created At' },
  'studioUser.currentPassword': { zh: '当前密码', en: 'Current Password' },
  'studioUser.disable': { zh: '禁用', en: 'Disable' },
  'studioUser.disabledSessionsRevoked': { zh: '用户已禁用，全部会话已注销', en: 'User disabled; all sessions were revoked' },
  'studioUser.disabledTag': { zh: '已禁用', en: 'Disabled' },
  'studioUser.enable': { zh: '启用', en: 'Enable' },
  'studioUser.enabledTag': { zh: '已启用', en: 'Enabled' },
  'studioUser.enabled': { zh: '用户已启用', en: 'User enabled' },
  'studioUser.export': { zh: '导出', en: 'Export' },
  'studioUser.exportFailed': { zh: '导出用户列表失败，请稍后重试', en: 'Failed to export users, please retry later' },
  'studioUser.exported': { zh: '已导出 {count} 个用户', en: 'Exported {count} user(s)' },
  'studioUser.filterByRoleAria': { zh: '按权限筛选', en: 'Filter by role' },
  'studioUser.filterByStatusAria': { zh: '按状态筛选', en: 'Filter by status' },
  'studioUser.initialPassword': { zh: '初始密码', en: 'Initial Password' },
  'studioUser.loadFailed': { zh: '加载用户列表失败', en: 'Failed to load the user list' },
  'studioUser.myAccount': { zh: '我的账号', en: 'My Account' },
  'studioUser.newPassword': { zh: '新密码', en: 'New Password' },
  'studioUser.notAdminDesc': { zh: '你可以修改自己的密码；用户列表和账号状态仅对管理员开放。', en: 'You can change your own password; the user list and account status are admin-only.' },
  'studioUser.notAdminTitle': { zh: '当前账号不是管理员', en: 'Current account is not an admin' },
  'studioUser.pageSubtitle': { zh: 'Studio 本地账号、会话与密码管理', en: 'Manage local Studio accounts, sessions and passwords' },
  'studioUser.pageTitle': { zh: '用户管理', en: 'User Management' },
  'studioUser.passwordChanged': { zh: '密码已修改，请使用新密码重新登录', en: 'Password changed; sign in again with the new password' },
  'studioUser.passwordMinLength': { zh: '密码至少 8 位', en: 'Password must be at least 8 characters' },
  'studioUser.passwordReset': { zh: '密码已重置，用户的现有会话已注销', en: 'Password reset; the user\'s existing sessions were revoked' },
  'studioUser.readerRole': { zh: '普通用户', en: 'User' },
  'studioUser.resetPassword': { zh: '重置 {name} 的密码', en: 'Reset password for {name}' },
  'studioUser.role': { zh: '权限', en: 'Role' },
  'studioUser.searchPlaceholder': { zh: '搜索用户名', en: 'Search username' },
  'studioUser.status': { zh: '状态', en: 'Status' },
  'studioUser.updateStatusFailed': { zh: '更新用户状态失败', en: 'Failed to update user status' },
  'studioUser.userId': { zh: '用户 ID', en: 'User ID' },
  'studioUser.username': { zh: '用户名', en: 'Username' },
